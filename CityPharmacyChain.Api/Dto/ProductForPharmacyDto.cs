...
public record ProductForPharmacyDto(string? pharmacyName = null, int? count = null, decimal? price = null, int? productCode = null, string? name = null, string? productGroup = null)
{
    /// <summary>
    /// Название аптеки
    /// </summary>
